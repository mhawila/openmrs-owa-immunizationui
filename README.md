...
This repository contains the immunizationui OpenMRS Open Web App.
...
This will create a file called `immunizationui.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/Users/mhawilamhawila/openmrs/openmrs-platform/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "/Users/mhawilamhawila/openmrs/openmrs-platform/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "/Users/mhawilamhawila/openmrs/openmrs-platform/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/immunizationui/index.html"
}
```
