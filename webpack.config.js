...
function createWebpackConfig(cliArgs) {
    const env = cliArgs.mode;
    const target = cliArgs.target;
    const targetPort = cliArgs.targetPort;
    ...
    const THIS_APP_ID = 'immunizationui';
    ...
    let config = (function getConfig() {
        ...
        try {
            ...
            config = {
                'LOCAL_OWA_FOLDER': '/Users/mhawilamhawila/openmrs/ra261/owa/',
    ...
    let browserSyncTarget = (function resolveBrowserSyncTarget() {
